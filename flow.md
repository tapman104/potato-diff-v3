...
| **[PositionState.kt](file:///c:/Users/tapman/Desktop/potatompv/mpvplayer/app/src/main/java/com/tapman104/mpvplayer/player/state/PositionState.kt)** | **Playback Timestamp State.** Dedicated state model for high-frequency position, duration, and buffer cache progress. | `copy()` | Emitted by `EventProcessor` via `PlayerViewModel` | Collected by `PlayerScreen`, seekbars |
