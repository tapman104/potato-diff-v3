...
[PlayerViewModel & SubtitleController]
       ...
       ├─► 8. For Decode Mode: Calls `cycleDecodeMode()` / `setDecodeMode()` -> sets property `"hwdec"`.
       ├─► 9. Persists styling and language preferences to [UserPreferencesRepository.kt](file:///c:/Users/tapman/Desktop/potatompv/mpvplayer/app/src/main/java/com/tapman104/mpvplayer/core/preferences/UserPreferencesRepository.kt) (Android DataStore).
```
